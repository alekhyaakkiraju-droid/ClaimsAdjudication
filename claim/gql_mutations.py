...
class CreateClaimMutation(OpenIMISMutation):
    ...
    def async_mutate(cls, user, **data):
        try:
            require_authenticated_mutation_user(user)
            ...
            op = (
                "claim.restore"
                if getattr(claim, "restore_id", None)
                else "claim.create"
            )
            record_claim_audit_event(
                ...
                user,
                claim=claim,
                context={"mutation": cls._mutation_class},
            )
            if attachments:
    ...
    def async_mutate(cls, user, **data):
        ...
        try:
            ...
            record_mutation_audit(
                ...
                user,
                claim=claim,
                context={"attachment_type": data.get("general_type")},
            )
            return None
        except Exception as exc:
            return mutation_error_list(
    ...
    def async_mutate(cls, user, **data):
        ...
        try:
            ...
            record_mutation_audit(
                ...
                user,
                claim=claim,
                context={"feedback_status": claim.feedback_status},
            )
            return None
        except Exception as exc:
            return mutation_error_list(
    ...
    def async_mutate(cls, user, **data):
        ...
        try:
            ...
            record_mutation_audit(
                ...
                user,
                claim=claim,
                context={"submit_review": submit_review},
            )
            return None
        except Exception as exc:
            return mutation_error_list(
    ...
    def async_mutate(cls, user, **data):
        ...
        for claim_uuid in data["uuids"]:
            ...
            if claim is None:
                ...
                continue
            record_claim_audit_event("claim.delete", user, claim=claim)
